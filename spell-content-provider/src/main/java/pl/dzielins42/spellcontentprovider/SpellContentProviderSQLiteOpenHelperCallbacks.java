...
public class SpellContentProviderSQLiteOpenHelperCallbacks extends BaseSQLiteOpenHelperCallbacks {
    ...
    private void createCompositeSpellView(Context context, SQLiteDatabase db) {
        ...
        aliasedColumns.add(createAlias(SchoolColumns.TABLE_NAME, SchoolColumns._ID, SpellCompositeColumns.SCHOOL__ID));
        aliasedColumns.add(createAlias(SchoolColumns.TABLE_NAME, SchoolColumns.NAME, SpellCompositeColumns.SCHOOL_NAME));
        aliasedColumns.add(createAlias(SubschoolColumns.TABLE_NAME, SubschoolColumns._ID, SpellCompositeColumns.SUBSCHOOL__ID));
        aliasedColumns.add(createAlias(SubschoolColumns.TABLE_NAME, SubschoolColumns.NAME, SpellCompositeColumns.SUBSCHOOL_NAME));
