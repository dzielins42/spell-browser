...
public class SpellContentProviderSQLiteOpenHelperCallbacks extends BaseSQLiteOpenHelperCallbacks {
    ...
    private static final String SCHOOL_HELPER_VIEW_NAME = "school_help_view";
    private static final String SCHOOL_HELPER_VIEW__ID = BaseColumns._ID;
    private static final String SCHOOL_HELPER_VIEW_LEVEL_NAME = "name";
    private static final String SCHOOL_HELPER_VIEW_LEVEL_ID = "id";
    ...
    public void onPostCreate(Context context, SQLiteDatabase db) {
        ...
        // Helper DB view for dealing with spell schools
        createSchoolHelpView(context, db);
    ...
    private void createSchoolHelpView(Context context, SQLiteDatabase db) {
        StringBuilder sb = new StringBuilder();
        List<String> aliasedColumns = new ArrayList<>();

        sb.append("CREATE VIEW IF NOT EXISTS ").append(SCHOOL_HELPER_VIEW_NAME).append(" AS ");

        // Top level
        sb.append("SELECT ");
        aliasedColumns.add(createAlias(SchoolColumns.TABLE_NAME, SchoolColumns._ID, SCHOOL_HELPER_VIEW__ID));
        aliasedColumns.add(createAlias(SchoolColumns.TABLE_NAME, SchoolColumns._ID, SCHOOL_HELPER_VIEW_LEVEL_ID + "1"));
        aliasedColumns.add(createAlias(SchoolColumns.TABLE_NAME, SchoolColumns.NAME, SCHOOL_HELPER_VIEW_LEVEL_NAME + "1"));
        aliasedColumns.add("NULL AS " + SCHOOL_HELPER_VIEW_LEVEL_ID + "2");
        aliasedColumns.add("NULL AS " + SCHOOL_HELPER_VIEW_LEVEL_NAME + "2");

        sb.append(StringUtils.join(aliasedColumns, ", "));

        sb.append(" FROM ").append(SchoolColumns.TABLE_NAME)
                .append(" WHERE ").append(SchoolColumns.PARENT_ID).append(" IS NULL");
        ...
        // Sub level
        sb.append("SELECT ");
        aliasedColumns.add(createAlias("s2", SchoolColumns._ID, SCHOOL_HELPER_VIEW__ID));
        aliasedColumns.add(createAlias("s1", SchoolColumns._ID, SCHOOL_HELPER_VIEW_LEVEL_ID + "1"));
        aliasedColumns.add(createAlias("s1", SchoolColumns.NAME, SCHOOL_HELPER_VIEW_LEVEL_NAME + "1"));
        aliasedColumns.add(createAlias("s2", SchoolColumns._ID, SCHOOL_HELPER_VIEW_LEVEL_ID + "2"));
        aliasedColumns.add(createAlias("s2", SchoolColumns.NAME, SCHOOL_HELPER_VIEW_LEVEL_NAME + "2"));

        sb.append(StringUtils.join(aliasedColumns, ", "));

        sb.append(" FROM ")
                .append(SchoolColumns.TABLE_NAME).append(" AS s1")
                .append(" JOIN ").append(SchoolColumns.TABLE_NAME).append(" AS s2")
                .append(" ON s2.").append(SchoolColumns.PARENT_ID).append(" = s1.").append(SchoolColumns._ID);
    ...
    private void createCompositeSpellView(Context context, SQLiteDatabase db) {
        ...
        aliasedColumns.add(createAlias(SCHOOL_HELPER_VIEW_NAME, SCHOOL_HELPER_VIEW__ID, SpellCompositeColumns.SCHOOL_ID));
        aliasedColumns.add(createAlias(SCHOOL_HELPER_VIEW_NAME, SCHOOL_HELPER_VIEW_LEVEL_ID + "1", SpellCompositeColumns.SCHOOL_LEVEL1_ID));
        aliasedColumns.add(createAlias(SCHOOL_HELPER_VIEW_NAME, SCHOOL_HELPER_VIEW_LEVEL_NAME + "1", SpellCompositeColumns.SCHOOL_LEVEL1_NAME));
        aliasedColumns.add(createAlias(SCHOOL_HELPER_VIEW_NAME, SCHOOL_HELPER_VIEW_LEVEL_ID + "2", SpellCompositeColumns.SCHOOL_LEVEL2_ID));
        aliasedColumns.add(createAlias(SCHOOL_HELPER_VIEW_NAME, SCHOOL_HELPER_VIEW_LEVEL_NAME + "2", SpellCompositeColumns.SCHOOL_LEVEL2_NAME));
        ...
        sb.append(SpellBaseColumns.TABLE_NAME)
                ...
                .append(" ON ").append(DescriptorColumns.TABLE_NAME).append(".").append(DescriptorColumns._ID).append(" = ").append(SpellsToDescriptorsColumns.TABLE_NAME).append(".").append(SpellsToDescriptorsColumns.DESCRIPTOR_ID).append(" AND ").append(SpellBaseColumns.TABLE_NAME).append(".").append(SpellBaseColumns._ID).append(" = ").append(SpellsToDescriptorsColumns.TABLE_NAME).append(".").append(SpellsToDescriptorsColumns.SPELL_ID)
                ...
                .append(" ON ").append(ComponentColumns.TABLE_NAME).append(".").append(ComponentColumns._ID).append(" = ").append(SpellsToComponentsColumns.TABLE_NAME).append(".").append(SpellsToComponentsColumns.COMPONENT_ID).append(" AND ").append(SpellBaseColumns.TABLE_NAME).append(".").append(SpellBaseColumns._ID).append(" = ").append(SpellsToComponentsColumns.TABLE_NAME).append(".").append(SpellsToComponentsColumns.SPELL_ID)
                ...
                .append(" LEFT OUTER JOIN ").append(SCHOOL_HELPER_VIEW_NAME)
                .append(" ON ").append(SCHOOL_HELPER_VIEW_NAME).append(".").append(SCHOOL_HELPER_VIEW__ID).append(" = ").append(SpellBaseColumns.TABLE_NAME).append(".").append(SpellBaseColumns.SCHOOL_ID);
