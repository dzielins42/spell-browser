...
import pl.dzielins42.spells.browser.view.spell.list.SpellListFragment.OnListFragmentInteractionListener;
...
public class MySpellRecyclerViewAdapter extends RecyclerView.Adapter<MySpellRecyclerViewAdapter.ViewHolder> {
    ...
    public MySpellRecyclerViewAdapter(
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_spell_list_item, parent, false);
